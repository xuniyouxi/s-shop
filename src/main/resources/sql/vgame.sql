...
INSERT INTO `t_biscuits` VALUES ('2', '广告', '/img/lll', '1');
INSERT INTO `t_biscuits` VALUES ('3', '欢迎页广告', '610544544', '1');
INSERT INTO `t_biscuits` VALUES ('7', '首页广告', '11', '2');
...
CREATE TABLE `t_user` (
  ...
  `user_passward` varchar(255) DEFAULT NULL COMMENT '用户密码',
